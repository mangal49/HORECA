...
class DeliveredHistory extends React.Component {
    state = {
        open: false,
        loading: true,
                                    ...
                                    <List>
                                        <ListItem
                                            leftAvatar={
                                                ...
                                                ><div style={{ fontSize: 9 }}>Delivered</div></Avatar>
                                            }
                                        ...
                                        >
                                            <div style={styles.divContent}>
                                                ...
                                                <div style={styles.listItemDetail}>
                                                    &nbsp;&nbsp;&nbsp;<span style={{ color: lightBlack }}>Deliver Date :</span> <span style={{ color: darkBlack }}>01/01/2017</span><br />
...
export default connect(mapStateToProps, actions)(DeliveredHistory);