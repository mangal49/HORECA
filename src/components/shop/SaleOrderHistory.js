...
class SaleOrderHistory extends React.Component {
    state = {
        open: false,
        loading: true,
            ...
            const rightIconMenu = (
                <IconMenu iconButtonElement={iconButtonElement}>
                    <MenuItem onClick={this.handleOpenOrderDetail}>
                        <div style={styles.popupMenu}>View Order</div>
                    </MenuItem>
                    <Divider />
                    <MenuItem onClick={this.handleOpenCancelDialog}>
                        <div style={styles.popupMenu}>Cancel Order</div>
                    </MenuItem>
                </IconMenu>
            );
            display = <div>
                                    ...
                                    <List>
                                        ...
                                        >
                                            <div style={styles.divContent}>
                                                <div style={styles.listItemHeader}>Order-00001</div>
                                        ...
                                        <ListItem
                                            leftAvatar={
                                                ...
                                                ><div style={{ fontSize: 11 }}>Picking</div></Avatar>
                                            }
                                            rightIconButton={rightIconMenu}
                                            style={{ height: 70 }}
                                        >
                                        ...
                                        >
                                            <div style={styles.divContent}>
                                                <div style={styles.listItemHeader}>Order-00004</div>
                                                <div style={styles.listItemDetail}>
                                                    &nbsp;&nbsp;&nbsp;<span style={{ color: lightBlack }}>Order Date :</span> <span style={{ color: darkBlack }}>20/01/2017</span><br />
                                                    &nbsp;&nbsp;&nbsp;<span style={{ color: lightBlack }}>Balance :</span> <span style={{ color: darkBlack }}>12,290 Bath</span>
                                                </div>
                                        ...
                                        >
                                            <div style={styles.divContent}>
                                                <div style={styles.listItemHeader}>Order-00007</div>
                                                <div style={styles.listItemDetail}>
                                                    &nbsp;&nbsp;&nbsp;<span style={{ color: lightBlack }}>Order Date :</span> <span style={{ color: darkBlack }}>20/01/2017</span><br />
                                                    &nbsp;&nbsp;&nbsp;<span style={{ color: lightBlack }}>Balance :</span> <span style={{ color: darkBlack }}>12,290 Bath</span>
                                                </div>
                                        ...
                                        >
                                            <div style={styles.divContent}>
                                                <div style={styles.listItemHeader}>Order-00008</div>
                                                <div style={styles.listItemDetail}>
                                                    &nbsp;&nbsp;&nbsp;<span style={{ color: lightBlack }}>Order Date :</span> <span style={{ color: darkBlack }}>20/01/2017</span><br />
                                                    &nbsp;&nbsp;&nbsp;<span style={{ color: lightBlack }}>Balance :</span> <span style={{ color: darkBlack }}>12,290 Bath</span>
                                                </div>
...
export default connect(mapStateToProps, actions)(SaleOrderHistory);